Skyway::Application.configure do
  ...
  config.cache_store = :dalli_store, ENV["DOKKU_MEMCACHED_AQUEOUSBAND_COM_PORT_11211_TCP_PORT"]
  ...
  config.assets.precompile += %w(sampler.css sampler.js native.css)
